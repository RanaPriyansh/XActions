...
Repository: https://github.com/RanaPriyansh/XActions.git
Canonical local path: /root/projects/XActions
Default branch: main
Current git summary: ## main...origin/main [ahead 2]
...
3. Run the local setup path for XActions and write exact commands back into README if they are missing or stale.
